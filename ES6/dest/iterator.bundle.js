...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var arr = [1, 2, 3, 4, 5];
	var set = new _set2.default(arr);
	var map = new _map2.default(arr);

	var arrIterator = (0, _getIterator3.default)(arr);
	var setIterator = (0, _getIterator3.default)(set);
	var mapIterator = (0, _getIterator3.default)(map);
