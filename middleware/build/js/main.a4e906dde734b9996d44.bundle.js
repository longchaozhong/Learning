...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreators = __webpack_require__(31);
	...
	var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.applyMiddleware)(loggerMiddleware));

	store.dispatch(_actionCreators2.default.request(123));
	store.dispatch(_actionCreators2.default.success(456));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = function reducer() {
	  ...
	  switch (action.type) {
	    case _actions2.default.REQUEST:
	      return { value: _actions2.default.REQUEST };
	    case _actions2.default.SUCCESS:
	      return { value: _actions2.default.SUCCESS };
	    case _actions2.default.FAILURE:
	      return { value: _actions2.default.FAILURE };
	  }
	}; /**
	    * Created by longcz on 2016/12/19.
	    */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = function request(data) {
	  return {
	    type: _actions2.default.REQUEST,
	    data: data
	  };
	}; /**
	    * Created by longcz on 2016/12/19.
	...
	var success = function success(data) {
	  return {
	    type: _actions2.default.SUCCESS,
	    data: data
	  };
	};
	var failure = function failure(data) {
	  return {
	    type: _actions2.default.FAILURE,
	    data: data
	  };
	};
