...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todoAppReducer = todoAppReducer;
	...
	var todos = function todos() {
	  ...
	  switch (action.type) {
	    case _actions.ADD_TODO:
	      {
	        return Object.assign([], state, [].concat(_toConsumableArray(state), [{ text: action.text, completed: false }]));
	      }
	    case _actions.TOGGLE_TODO:
	      {
	        return Object.assign([], state, state.todos.map(function (todo, index) {
